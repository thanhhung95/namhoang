...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__NhansuItem__ = __webpack_require__(41);
...
var NhansuList = function (_Component) {
    _inherits(NhansuList, _Component);

    function NhansuList() {
        _classCallCheck(this, NhansuList);

        var _this = _possibleConstructorReturn(this, (NhansuList.__proto__ || Object.getPrototypeOf(NhansuList)).call(this));
    ...
    _createClass(NhansuList, [{
        key: 'componentWillMount',
        value: function componentWillMount() {
            var _this2 = this;

            __WEBPACK_IMPORTED_MODULE_2_axios___default.a.get('/api/nhansu').then(function (response) {
                _this2.setState({
                    nhansu: response.data
                });
        ...
        value: function render() {
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                'ul',
                { className: 'list-group clear-list', id: 'danhsach-nhansu' },
                this.state.nhansu.map(function (item) {
                    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__NhansuItem__["a" /* default */], { key: item.id, hodem: item.hodem, ten: item.ten, donvi: item.donvi, maso: item.maso, id: item.id });
                })
            );
        }
    }]);
...
/* harmony default export */ __webpack_exports__["default"] = (NhansuList);


if (document.getElementById('nhansuList')) {
    __WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(NhansuList, null), document.getElementById('nhansuList'));
}
...
var NhansuItem = function (_Component) {
    _inherits(NhansuItem, _Component);

    function NhansuItem() {
        _classCallCheck(this, NhansuItem);

        return _possibleConstructorReturn(this, (NhansuItem.__proto__ || Object.getPrototypeOf(NhansuItem)).apply(this, arguments));
    }

    _createClass(NhansuItem, [{
        key: "render",
        value: function render() {
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                "li",
...
/* harmony default export */ __webpack_exports__["a"] = (NhansuItem);
