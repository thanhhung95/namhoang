...
@section('content')
    <div class="row dataTables_wrapper">
        ...
        <div class="col-sm-3">
            ...
            <input value="{{$get_bill->name}}" type="text" class="form-control" disabled>
        </div>
        <div class="col-sm-3">
            <label>Số điện thoại:</label>
            <input value="{{$get_bill->phone}}" type="text" class="form-control" disabled>
        </div>
        <div class="col-sm-3">
            <label>Thời gian đặt:</label>
            <input value="{{$get_bill->time_bill}}" type="text" class="form-control" disabled>
        </div>
        <div class="col-sm-3">
        ...
        <div class="col-sm-6">
            <div class="row">
                <div class="col-sm-12">
                    <label>Email:</label>
                    <input value="{{$get_bill->email}}" type="text" class="form-control" disabled>
                </div>
        ...
        <div class="col-sm-6">
            <label>Mô tả:</label>
            <textarea rows="4" cols="50" class="form-control" disabled>{{$get_bill->description}}</textarea>
        </div>
    </div>
	<div class="row">
        ...
        <div class="col-sm-4 mt-5 mb-5 text-right">
            <a href="{{route('export',[$get_bill->id,'BILL'])}}" class="btn btn-info btn-sm">Excel <i class="fa fa-file-excel-o"></i></a>
        </div>
        <div class="col-sm-12">
